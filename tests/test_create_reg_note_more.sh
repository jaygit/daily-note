...
# Additional tests for create_reg_note.sh
# - multiple selected notes receive backlinks
# - creating a note without a project does not add project frontmatter
...
# Clean extra-tests for create_reg_note.sh
# This file is written atomically to avoid previous corruption issues.
